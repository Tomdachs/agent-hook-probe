...
- Generated fixtures must be disposable and contain only probe-owned files; generated hook config must stay inside that fixture or a provider-scoped invocation override.
